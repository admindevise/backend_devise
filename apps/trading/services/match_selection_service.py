...
from apps.trading.audit_helper.audit_helper_select_match_orders import AuditHelperSelectMatchOrders as AuditService
...
class MatchSelectionService:
    ...
    def process_auto_match_selection(
        ...
        try:
            ...
            AuditService._log_auto_selection_audit(
            ...
            AuditService._log_warning_audit(purchase_order, str(w), w.warning_data, user, request)
            raise
        except Exception as e:
            # Registrar auditoría de error
            AuditService._log_error_audit(purchase_order, str(e), user, request)
    ...
    def process_match_selection(
        ...
        try:
            ...
            AuditService._log_selection_audit(purchase_order, selection_summary, user, request)
