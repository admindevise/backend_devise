...
class AuditLogViewSet(DateFilterMixin, viewsets.ReadOnlyModelViewSet):
    ...
    filterset_fields = ['action__code', 'user__id', 'status', 'content_type__model', 'transaction_id', 'blockchain_tx_hash']
    search_fields = ['transaction_id', 'blockchain_tx_hash', 'object_id', 'user__email', 'action__name']
