...
class OperatingDataRepository:
    ...
    def get_income_by_period(
        ...
        return AssetOperatingIncome.objects.filter(filters).first()
    ...
    def get_expense_by_period(
        ...
        period_month: Optional[int] = None,
        period_quarter: Optional[int] = None
    ) -> Optional[AssetOperatingExpense]:
        """
        ...
        return AssetOperatingExpense.objects.filter(filters).first()
    ...
    def get_income_range(
        ...
        Returns:
            QuerySet de AssetOperatingIncome
        """
        return AssetOperatingIncome.objects.filter(
            asset=asset,
            period_type=period_type
        ).filter(
            Q(
    ...
    def get_expense_range(
        ...
        end_year: int,
        end_month: int
    ) -> QuerySet[AssetOperatingExpense]:
        """
        ...
        Returns:
            QuerySet de AssetOperatingExpense
        """
        return AssetOperatingExpense.objects.filter(
            asset=asset,
            period_type=period_type
        ).filter(
            Q(
    ...
    @staticmethod
    def get_total_income(incomes: QuerySet[AssetOperatingIncome]) -> Decimal:
        """
    ...
    @staticmethod
    def get_total_expenses(expenses: QuerySet[AssetOperatingExpense]) -> Decimal:
        """
